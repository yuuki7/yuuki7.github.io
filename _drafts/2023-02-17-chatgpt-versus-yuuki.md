...
* ChatGPT shared link https://chat.openai.com/share/f406a004-ca2c-449d-b2ca-869f722dd458
* Pastebin https://pastebin.com/7qirN6mp [^1]
...
I repeated this process.  In the end, I also had to say the following to ChatGPT every time:
...
[^1]: This paste was generated by running the following JavaScript code in the Brave (i.e., Chromium) console on the chat page.  As of ChatGPT Feb 13 version, it renders the conversation in div elements with the `whitespace-pre-wrap` class.  (This may not work in the future.)
